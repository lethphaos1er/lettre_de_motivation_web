export function projets() {
    const projets = [
        ...
        {name: "Retro Monster" ,type:"jeu vidéo" ,description: "une base de donnée de Monstre pour un jeu tupe jeu de carte à collectionner",url:"https://github.com/lethphaos1er/retro_monster_examen"} 
    ]
    return {
        projets
    }
